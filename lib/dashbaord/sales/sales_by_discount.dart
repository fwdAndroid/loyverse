...
class SalesByDiscounts extends StatefulWidget {
  const SalesByDiscounts({super.key});

  @override
  State<SalesByDiscounts> createState() => _SalesByDiscountsState();
}

class _SalesByDiscountsState extends State<SalesByDiscounts> {
